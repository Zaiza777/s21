...
#          echo "$TEST4"
          ...
          TEST5="$var $var2 $var3 -f pattern.txt $FILENAME1 $FILENAME2 $FILENAME3 $FILENAME4 $FILENAME5"
          echo "$TEST5"
          ...
          TEST6="$var $var2 $var3 -f pattern.txt $FILENAME1 $FILENAME2 $FILENAME3 $FILENAME4 $FILENAME5"
          echo "$TEST6"
